    ...
    <div class="login-container">
      ...
      <div class="brand-side">
        <div class="brand-content">
          ...
          <p class="brand-subtitle">Projelerinizi yönetin, hedeflerinize ulaşın.</p>
          <div class="brand-features">
            <div class="feature-item">
              ...
              <span>Kanban board ile görev takibi</span>
            </div>
            <div class="feature-item">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <span>Ekip işbirliği ve yetkilendirme</span>
            </div>
            <div class="feature-item">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="form-wrapper">
          ...
          <form @submit.prevent="handleLogin" class="login-form">
            ...
            <button type="submit" :disabled="authStore.loading" class="submit-btn">
              <span v-if="!authStore.loading">Giriş Yap</span>
